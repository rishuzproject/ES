...
/**
 * The persistent class for the budget_form_indirect database table.
 * 
 * @author Ashutosh
 ...
 */
@Entity
@Table(name = "BUDGET_FORM_INDIRECT")
public class BudgetFormIndirect implements Serializable {
