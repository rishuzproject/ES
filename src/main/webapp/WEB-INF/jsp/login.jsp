...
<body
	...
	<header id="header">
		...
		<div id="logo-group">
			<span id="logo"> <img src="./assets/img/logo.png"  style="height:35px;width:116px;position: relative;top: -5px;"
				alt="EcoSystem">
			</span>
		</div>
		<span id="extr-page-header-space"> <span class="hidden-mobile">Still Not Signed Up?</span> <a
			href="registration"
			class="btn btn-danger">Create account</a>
		</span>
	...
	<div id="main" role="main">
		...
		<div id="content" class="container">
			...
			<div class="row">
					...
					<div class="hero">
						...
						<div class="pull-left login-desc-box-l">
							<h4 class="paragraph-header">
								...
								usage info at a single place.</br> Just sign in to feel the next-gen
								business tool.
							</h4>
						</div>
				...
				<div><font color="blue">${result}</font></div>
					<div class="well no-padding">
						<form action="home" id="login-form" class="smart-form client-form"
							...
							<fieldset>
								...
								<section>
									<label class="label">Domain</label> <label class="input">
										<i class="icon-append fa fa-users"></i> <input type="text"
										name="domain"> <b class="tooltip tooltip-top-right"><i
											class="fa fa-users txt-color-teal"></i> Enter your Companies
											domain name</b>
									</label>
									<div class="note">
										<a
